...
let ct_mul_seeded ~math:_ _ _ _ _ = unavailable ()
let ct_scale ~math:_ _ _ _ = unavailable ()
let ct_div_const _ _ _ _ = unavailable ()
let ct_add_const ~math:_ _ _ _ _ = unavailable ()
let ct_sub_const ~math:_ _ _ _ = unavailable ()
let commit_ct _ _ = unavailable ()
let pedersen_commit_amount _ _ = unavailable ()
let pedersen_identity () = unavailable ()
let pedersen_add _ _ = unavailable ()
let pedersen_sub _ _ = unavailable ()